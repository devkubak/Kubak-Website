  ...
  background-filter: #212121;"
      ...
      >
        ...
        <div
          ...
          style="width: 100%;"
        >
        <p class="absolute z-50 text-white text-center rounded-full font-bold text-lg w-full h-16 flex {$locale == "en" ? "font-Bahij_Plain" : "font-Bahij_Plain_Plain"}  justify-center items-center" id="title-text">{checkLanguage(selectedLanguage, development.title)}</p>
          <div
            class="content-container font-bold "
            id="description"
            class:selected={selectedCard === index}
          >
            <h4 class="text-[#f17f18] text-sm md:text-lg duration-300 ease-in-out {$locale == "en" ? "font-Bahij_Plain" : "font-Bahij_Plain_Plain"}" style="font-family: font-Bahij_Plain;">
