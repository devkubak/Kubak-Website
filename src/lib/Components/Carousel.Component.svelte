  ...
  function redirectToStore() {
    ...
    if (/android/i.test(userAgent)) {
      window.location.href =
        "https://play.google.com/store/apps/details?id=co.kubak.city&hl=en&gl=US";
    }
    // iOS
        ...
        {#each $carouselStore.data as carousel}
          ...
          <a title={carousel.title.en} class="block relative">
            ...
            {#if $locale == "en"}
              ...
              >
                <div
                  class="w-full h-28 md:h-[32rem] absolute left-0 bottom-0 bg-gradient-to-t from-[#000000]"
                ></div>
                <div
                  class="absolute bottom-0 left-0 w-full h-full flex justify-start pb-24 md:pb-48 flex-col-reverse text-center md:pl-12 md:text-4xl items-center md:items-start p-2 gap-4 text-xl lg:text-6xl xl:text-6xl 2xl:text-[4rem]"
              ...
              <div
                class="w-11/12 h-16 ml-5 mb-4 absolute z-50 bottom-0 flex md:hidden justify-center items-center"
                data-aos="fade-up"
              ...
              >
                <button>
                  ...
                  <span
                    id="downloadButton"
                    on:click={redirectToStore}
                    style="font-family: Bahij;">{$_("downloadApp")}</span
                  >
                </button>
              </div>
            {:else}
              ...
              >
                ...
                ></div>
                <div
                  class="absolute bottom-0 left-0 w-full h-full flex justify-start pb-24 md:pb-48 flex-col-reverse text-center md:pr-12 md:text-4xl items-center md:items-end p-2 gap-4 text-xl lg:text-6xl xl:text-6xl 2xl:text-[4rem]"
              ...
              >
                <button>
                  ...
                  <span
                    ...
                    on:click={redirectToStore}>{$_("downloadApp")}</span
                  >
                </button>
              </div>
            {/if}
