export namespace Environment {
  ...
  export const appwrite_collection_privacies: string =
    ENVIRONMENT.VITE_APPWRITE_PRIVACIES_ID;
  export const appwrite_collection_privacyInformations: string =
    ENVIRONMENT.VITE_APPWRITE_PRIVACY_INFORMATIONS_ID;
