      ...
      <div class="w-full h-[540px] flex flex-col justify-end items-center " >
        ...
        <div class="w-full h-12 flex justify-between items-center text-center bg-[#ffffff9a] dark:bg-[#21212192]" >
          ...
          {#if technologies.length > 0}
            <p class="w-full h-12 text-center flex justify-center items-center bg-white dark:bg-[#3a3a3a] dark:text-white text-2xl font-bold {$locale == "en" ? "text-Bahij_Plain" : "text-Bahij_Plain_Plain"}">{technologies[currentTechnologyIndex].title[$locale + ""]}</p>
          {/if}
