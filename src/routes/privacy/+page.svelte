...
<div class="container mx-auto flex justify-center items-center  md:flex-row flex-col-reverse  flex-wrap md:flex-nowrap px-4  pt-32" data-aos="fade-up" data-aos-duration="2000">
    <div class="w-full h-auto dark:bg-gradient-to-b shadow-inner shadow-[#f17d1868] dark:from-[#2f2f2f] dark:via-[#1c1c1c] dark:o-[#2f2f2f]   bg-gradient-to-b from-[#f6f6f6] via-[#dddddd] to-[#f6f6f6] dark:text-white rounded-3xl p-12 flex flex-col gap-4">
        ...
        <div class="w-full flex flex-col font-bold">
            ...
            <p class="text-lg md:text-4xl text-[#f17f18] " style="font-family: text-Bahij_Plain;">
        ...
        <div class="w-full flex flex-col gap-24">
            <p class="text-justify">
                Policy describes how we, Kubak ( “we, “us” or “our”) collect, store, use, process, retain, transfer, disclose and protect your Personal Information. This Privacy Policy applies to all users of our applications, websites (www.kubakgroup.com), services, or products (“Applications”), unless covered by a separate privacy policy.
...
<div class="w-full flex flex-col">
    <p class="font-bold">This Privacy Policy includes the following matters:</p>
    <p>– Personal Information which we collect <br>
        – The use of Personal Information which we collect<br>
        – Sharing of Personal Information which we collect<br>
        – Retention of Personal Information Access and correction of Personal Information<br>
        – Where we store your Personal Information<br>
...
Information obtained from you or from your mobile device directly When you register and create an account with us using the Application you have to provide to us certain Personal Information, including your name and your phone number.
 
If you are using the Application as a service provider, you have to provide us with additional Personal Information as part of the service provider onboarding process. This would include details of your vehicle (licenses, approvals, and other authorizations for you to operate the vehicle and to provide the transportation services), your insurance policy, and your bank account.
...
If you utilize and/or when a payment or transfer is made through the electronic money and/or electronic wallet facility provided by us, if you are the payer or sender, you will provide us the information relating to the utilization, payment or transfer.
...
Whenever you use the Application through your mobile device, we will track and collect your geo-location information in real-time. In some cases, you will be prompted or required to activate the Global Positioning System (GPS) on your mobile device to enable us to give you a better experience in using the Application (for example, to give you information as to how close a service provider is to you).
You can always choose to disable the geo-location tracking information on your mobile device temporarily. However, this can affect the functionalities available on the Application.
...
If you utilize virtual account provided by us to receive electronic money and/or electronic wallet payment from payer, whether you are a service provider or merchant, we may collect certain information related to your utilization including but not limited to service and/or goods transacted, amount you collect from every transaction, withdrawal or settlement account details and withdrawal or settlement history.
...
to facilitate or enable any verification as we may in our discretion consider necessary before the service provider provide you with the services or before we register you as a user;
to enable service providers to provide you with such of the services as you have requested; to process and facilitate orders and payment transactions made by you, including where applicable, transactions made through any payment card or account available over the Application;
to notify you of any transaction or activities occurred within the Application;
...
to facilitate or enable any verification as we may in our discretion consider necessary before we register you as a service provider;
      ...
      <Accordion defaultClass="bg-white dark:bg-[#212121] rounded-3xl border-0">
        ...
        defaultClass="rounded-3xl w-full bg-white flex items-center justify-between  font-bold dark:bg-[#212121] dark:text-white" inactiveClass="hover:bg-[#f1f1f1] dark:hover:bg-[#252525]" activeClass="focus:ring-gray-200 dark:focus:ring-[#252525] dark:text-white focus:ring-4 duration-300 ease-in-out">
            ...
            <p class="mb-2 text-black dark:text-white text-justify">
              ...
              where required or authorised by applicable law (including but not limited to responding to regulatory enquiries, investigations or directives, or complying with statutory or regulatory filing and reporting, and licensing requirements), for the purpose so specified in that applicable law;
              ...
              in relation to any verification as we or other third party may consider necessary before the service provider provide you with the services or we register you as a user;
      ...
      <Accordion defaultClass="bg-white dark:bg-[#212121] rounded-3xl border-0">
        ...
        defaultClass="rounded-3xl w-full bg-white flex items-center justify-between  font-bold dark:bg-[#212121] dark:text-white" inactiveClass="hover:bg-[#f1f1f1] dark:hover:bg-[#252525]" activeClass="focus:ring-gray-200 dark:focus:ring-[#252525] dark:text-white focus:ring-4 duration-300 ease-in-out">
            ...
            <p class="mb-2 text-black dark:text-white text-justify">
              ...
              <br>
              Email For Customer Support and correction to your Personal Information: <span class="text-[#f17f18]">info@kubakgroup.com</span> <br>
              Call Center For Customer and  Driver Support in Sulimaniyah: <span class="text-[#f17f18]">(0773) 0797475</span>. <br>
              Call Center For Customer and  Driver Support in Erbil: <span class="text-[#f17f18]">(0750) 1394042</span>. <br>
            </p>
          </AccordionItem>
      </Accordion>
</div>