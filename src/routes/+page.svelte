...
>
  <p
    class="leading-10 duration-150 ease-in-out cssanimation leBlurIn sequence"
  ...
  <div
    class="text-[#f17f18] hover:text-[#f19718] my-5 cursor-pointer ease-in-out duration-300"
    style="font-family:Bahij_Plain;"
    on:click={toggleShowFullText}
  >
...
<div class="w-full flex justify-center items-center text-center mt-12">
  <p
    class="text-black dark:text-white font-bold py-3 mt-3 md:text-4xl"
    style="font-family:Bahij_Plain;"
